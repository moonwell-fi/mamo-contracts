...
interface INonfungiblePositionManager {
    ...
    /// @return The token ID at `index` of tokens owned by `owner`
    ...
    /// @notice Safely transfers the ownership of a given token ID to another address with additional data
    /// @param from The current owner of the token
    /// @param to The address to receive the ownership of the given token ID
    /// @param tokenId The ID of the token to transfer
