...
contract StrategyFactory {
     ...
     * @param _marketRegistry Address of the MarketRegistry contract
     ...
     * @param _defaultSplitBps Array of default split basis points for each market
     */
    constructor(
     ...
     * @dev Only callable by the backend or the user themselves
