...
contract DeployFactoriesAndMulticall is MultisigProposal {
    ...
    constructor() {
        ...
        deployStrategyMulticall = new DeployStrategyMulticall();
        vm.makePersistent(address(deployStrategyMulticall));
    }
    ...
    function deploy() public override {
        ...
        console.log("StrategyMulticall deployed at:", strategyMulticall);
    }
    ...
    function validate() public view override {
        ...
        assertTrue(strategyMulticall != address(0), "StrategyMulticall should be deployed");
        ...
        // Validate StrategyMulticall owner
        StrategyMulticall multicall = StrategyMulticall(strategyMulticall);
        assertEq(multicall.owner(), currentBackend, "StrategyMulticall owner should be the backend");
