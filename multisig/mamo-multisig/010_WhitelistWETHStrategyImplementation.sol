 ...
 * @notice Multisig proposal to whitelist a new strategy implementation for USDC, cbBTC, and WETH accounts.
...
contract WhitelistWETHStrategyImplementation is MultisigProposal {
    ...
    function deploy() public override {
        ...
        if (addresses.isAddressSet("MOONWELL_MORPHO_STRATEGY_IMPL")) {
            ...
            // Only keeping the latest deprecated implementation
            addresses.changeAddress("MOONWELL_MORPHO_STRATEGY_IMPL_DEPRECATED", oldAddress, true);
        ...
        strategyFactoryDeployer.deployStrategyFactory(addresses, configWeth, deployer);
    }
