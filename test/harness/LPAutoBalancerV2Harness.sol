...
///         These setters write fields BY NAME — a reorder is either transparent or a compile
///         error, never silent corruption. Production code is untouched; this contract lives in
///         test/ and is never deployed.
